...
const InputForm = ({label, id, placeholder, className, variant, type, onChange}) => {
    const baseClass = 'px-4 py-2 rounded-[15px] border-2 border-gray-100 bg-white lg:h-[62px] md:h-[53px] h-[45px] pl-[20px] lg:text-h4 md:text-h5 text-h6 md:placeholder:text-h5 placeholder:text-h6';
    let layout = ''
