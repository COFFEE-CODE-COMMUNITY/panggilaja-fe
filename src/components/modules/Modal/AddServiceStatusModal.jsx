...
const AddServiceStatusModal = ({className}) => {
  return (
    <div id="hs-scale-animation-modal" className={`hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto pointer-events-none ${className}`} role="dialog" tabindex="-1" aria-labelledby="hs-scale-animation-modal-label">
...
export default AddServiceStatusModal