    ...
    <>
        <div className='xl:h-[80px] lg:h-[72px] md:h-[64px] sm:h-[56px] h-[48px] w-full flex justify-center xl:gap-[35px] lg:gap-[27px] md:gap-[19px] sm:gap-[10px] gap-[2px] items-center xl:px-[150px] lg:px-[100px] md:px-[40px] px-[25px] sticky top-0 bg-white z-200'>
            <div className='h-full flex items-center justify-center lg:pr-[125px] md:pr-[80px] pr-[10px]'>
                <NavLink link='/' text='PanggilAja' className='md:text-h4 text-h5 text-secondary font-bold'/>
            </div>
            ...
            {sidebarProfile && (
                <div className='sm:absolute sm:flex justify-end hidden right-[150px] top-[80px] gap-[5px]'>
                    {favorite && (
        ...
        {sidebarMobile && (
            <div className='sm:hidden fixed w-full top-0 bottom-0 bg-white z-100 flex flex-col py-[50px] px-[15px]'>
                <div>
