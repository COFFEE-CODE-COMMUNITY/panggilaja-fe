...
const ChatLayout = () => {
  ...
  return (
    <div className='md:h-[91vh] h-[85vh] w-full flex'>
        <div className={`h-full sm:w-1/5 w-full px-[10px] py-[5px] sm:flex flex-col lg:gap-[20px] md:gap-[15px] ${chatMobile ? 'hidden' : ''}`}>
          ...
          <div className='h-full overflow-auto flex flex-col gap-[10px] sm:my-0 my-[15px]'>
            <NavLink 
        ...
        <div className={`h-full sm:w-4/5 sm:flex flex-col w-full ${chatMobile ? '' : 'hidden'}`}>
          ...
          <div className='w-full h-full bg-chat/25 flex flex-col relative flex-1'>
