...
const ProfileLayout = () => {
  ...
  if (status === "success") {
    ...
    const skills = seller?.pengalaman
      ...
      : [];
    return (
      <div className={`flex flex-col color h-full ${isBuyer ? "mt-20" : ""}`}>
        <div
<<<<<<< Updated upstream
...
>>>>>>> Stashed changes
        >
          <div className="md:h-full rounded-3xl border-1 border-solid mt-5 border-gray-100 flex md:flex-col md:items-center lg:px-[15px] lg:py-[35px] md:px-[10px] md:py-[30px] px-[5px] sm:py-[25px] py-[15px] gap-[15px]">
            <img
