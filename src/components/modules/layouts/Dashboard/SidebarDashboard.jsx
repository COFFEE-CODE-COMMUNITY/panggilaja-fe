...
    console.log(modalProfile)
    return (
        <aside className={`bg-white sm:flex hidden px-10 py-5 flex flex-col justify-between h-screen fixed w-70 border-r-gray-100 border-1 shadow-sm`}>
          <div>
            {/* Logo */}
            <div>
                  ...
                  >
                    <span className="flex items-center">
                      <svg className="mr-3 stroke-gray-500 group-hover:stroke-white" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M21 4.77246H3C2.58579 4.77246 2.25 5.14556 2.25 5.60579V18.9391C2.25 19.3994 2.58579 19.7725 3 19.7725H21C21.4142 19.7725 21.75 19.3994 21.75 18.9391V5.60579C21.75 5.14556 21.4142 4.77246 21 4.77246Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M15.75 16.0225H18.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M11.25 16.0225H12.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M2.25 9.35645H21.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      Pesanan
                    </span>
                  </NavLink>
                  ...
                  >
                    <span className="flex items-center">
                      <svg className="mr-3 stroke-gray-500 group-hover:stroke-white" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M16.5938 14.5693V9.69434L7.5 4.67871" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M20.8953 7.2666L12.0828 12.2729L3.10156 7.2666" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M12.0844 12.2725L12 22.285" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                      Produk
                    </span>
                  </NavLink>
            ...
            <div>
              ...
              <div className="group flex items-center pr-3 py-2 text-sm text-gray-500 rounded-lg justify-between cursor-pointer">
                ...
                <svg className="hover:stroke-white rotate-90" width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.91797 9.27246L6.35087 5.27246L1.91797 1.27246" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
