  ...
  return (
    <footer className="w-full bg-primary text-white py-10 px-6 md:px-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
        {/* Logo & Deskripsi */}
        <div>
          <h2 className="text-2xl font-bold mb-3">PanggilAja</h2>
          <p className="text-sm text-gray-200 leading-relaxed">
            Marketplace jasa lokal yang menghubungkan pelanggan dengan penyedia
            layanan profesional secara cepat dan mudah.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-200">
            ...
            <li>
              <a href="/help" className="hover:text-indigo-300 transition">
                Pusat Bantuan
              </a>
            </li>
          </ul>
      ...
      {/* Garis bawah */}
      <div className="border-t border-white mt-10 pt-6 flex flex-col md:flex-row justify-center items-center text-sm text-gray-300">
        <p>
          © 2025 <span className="font-semibold text-white">PanggilAja!</span>.
          All rights reserved.
        </p>
      </div>
    </footer>
