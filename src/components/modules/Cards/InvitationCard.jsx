...
const InvitationCard = ({children, className}) => {
    const baseClass = 'bg-secondary w-full md:rounded-[40px] rounded-[30px] lg:px-[40px] lg:py-[30px] md:px-[30px] md:py-[20px] px-[20px] py-[15px] flex flex-col md:gap-[15px] gap-[5px]';
