...
import { useEditService, useGetCategoryService } from '../../../hooks/useServices';
...
const FormEditService = ({ serviceName, basePrice, topPrice, description, category, id, image }) => {
    ...
    const { mutateAsync: editServiceMutate, status: editStatus } = useEditService();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await editServiceMutate({ id, data: serviceData });
            setModalEdit(true);
        } catch (error) {
