...
export default function Faq() {
  ...
  return (
    <section className="relative py-16 md:py-20 px-6 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              <div className="divide-y divide-gray-100">
                {dataFaq.map((item, index) => (
                  <div
                    key={item.id}
                    className={`transition-all duration-300 ${openId === item.id ? "bg-primary/5" : "hover:bg-gray-50"
                      }`}
                  >
                    {/* Question Button */}
                    <button
                    ...
                    >
                      {/* Number Badge */}
                      <div
                        className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${openId === item.id
                      ...
                      <div className="flex-1">
                        <h3
                          className={`font-semibold text-base md:text-lg leading-relaxed transition-colors duration-300 ${openId === item.id
                              ? "text-primary"
                      ...
                      <div className="flex-shrink-0">
                        <FaChevronDown
                          className={`text-gray-400 transition-all duration-300 ${openId === item.id
