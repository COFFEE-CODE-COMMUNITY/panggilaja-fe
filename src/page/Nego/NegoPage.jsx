...
const NegoPage = () => {
  ...
  // 🔥 UPDATED: handleConfirmNego dengan field Pesan
          ...
          <div className="md:w-3/4 w-full md:h-full lg:py-[25px] md:py-[15px] py-[10px] flex flex-col gap-[20px] sm:border-2 sm:border-gray-100 bg-white rounded-lg">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-primary mb-1">
                    Sebaiknya Chat Penjual Terlebih Dahulu
                  </h4>
                  <p className="text-sm mb-3">
                    Untuk hasil terbaik, diskusikan kebutuhan Anda dengan
                    penjual sebelum mengajukan penawaran. Ini membantu
                    memastikan harga dan layanan sesuai ekspektasi.
                  </p>
                  <button
                    type="button"
            ...
            <div className="md:hidden border-2 border-gray-100 bg-white px-[10px] py-[5px] flex flex-col gap-[10px] rounded-lg">
              ...
              >
                <img
                  ...
                  className="w-1/3 h-30 object-cover rounded-[10px]"
                />
                <div className="flex flex-col justify-center">
                  <p className="font-medium">{service?.nama_jasa}</p>
                  <p className="text-sm text-gray-600">
                    Rp {service?.base_price?.toLocaleString()} - Rp{" "}
                    {service?.top_price?.toLocaleString()}
                  </p>
                </div>
              </Link>
            </div>
            ...
            <div>
              ...
              <div className="w-full px-[15px] py-[10px] bg-gray-50 rounded-[15px] border border-gray-200">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm text-gray-600">
                    {address?.data?.alamat}, {address?.data?.kota},{" "}
                    {address?.data?.kecamatan}, {address?.data?.provinsi},{" "}
                    {address?.data?.kode_pos}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-[20px]">
              <div>
                ...
                <div className="flex flex-col gap-2 mb-4">
                  ...
                  <p className="text-xs text-gray-500">
                    Range harga: Rp {service?.base_price?.toLocaleString()} - Rp{" "}
                    {service?.top_price?.toLocaleString()}
                  </p>
                </div>
              ...
              <p className="text-xs text-center text-gray-500">
                Dengan mengirim penawaran, Anda menyetujui untuk berkomunikasi
                dengan penjual melalui chat
              </p>
            </div>
          </div>
