    ...
    >
      ...
      <div className="relative z-10 px-6 md:px-18 lg:px-24 text-white text left mt-16 md:mt-39 lg:mt-[200px]">
        ...
        <p className="mt-3 text-[14px] md:text-[20px] lg:text-[24px] font-light">
          Perluas jangkauan pelanggan di lingkungan terdekatmu. Gratis biaya
          pendaftaran!
        </p>
          ...
          <div className="flex flex-col justify-between gap-3 md:flex-row md:gap-10 mb-10">
            ...
            <div className="flex-1 text-left">
              <p className="text-gray-600 text-[15px] md:text-[16px] lg:text-[17px] leading-relaxed">
                PanggilAja adalah solusi digital yang membuat keahlian Anda
                ditemukan, membangun reputasi, dan memberi Anda kendali penuh
                atas usaha Anda.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left gap-8 text-left">
            {isiCard.map((item) => (
              <div key={item.id} className="text-gray-800">
                <h3 className="font-semibold mb-3 text-[20px] md:text-[19px] lg:text-[23px]">
                  {item.title}
                </h3>
                <p className="text-[14px] md:text-[14px] lg:text-[16px] text-gray-600 leading-relaxed">
                  {item.desc}
                </p>
              </div>
            ))}
